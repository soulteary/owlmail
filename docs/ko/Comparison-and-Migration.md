...
OwlMail 0.9.0은 기본적으로 비활성화된 읽기 전용 MCP 인터페이스를 Streamable HTTP와 stdio로 제공합니다. MailDev 3의 MCP 범위는 더 넓고 MailCatcher와 Mailpit에는 내장 MCP가 없습니다. Mailpit용 호환 facade도 없습니다. 기본적으로 비활성화된 `-maildev-rest-compat` 옵션은 현재 MailDev REST 경로를
