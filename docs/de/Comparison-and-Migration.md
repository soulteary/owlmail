...
OwlMail 0.9.0 bietet standardmäßig deaktivierte, schreibgeschützte MCP-Schnittstellen über Streamable HTTP und stdio. MailDev 3 bietet einen breiteren MCP-Workflow; MailCatcher bietet kein integriertes MCP. Die standardmäßig deaktivierte Option `-maildev-rest-compat` stellt die aktuellen
