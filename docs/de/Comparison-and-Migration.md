# OwlMail × MailDev × MailCatcher × Mailpit: Funktions-, API- und Migrationsleitfaden

> **Ein tiefer Quellcode-Vergleich + Migrationsleitfaden für Benutzer und Entwickler**

> ⚠️ **Dokument in Übersetzung**
> 
> Diese Übersetzung ist in Arbeit. Bitte konsultieren Sie vorerst die [englische Version](../en/Comparison-and-Migration.md) oder andere verfügbare Versionen:
...
OwlMail, MailDev, MailCatcher und Mailpit decken dieselben grundlegenden Entwicklungsabläufe ab, sind
...
OwlMail 0.10.0 bietet standardmäßig deaktivierte, schreibgeschützte MCP-Schnittstellen über Streamable HTTP und stdio. MailDev 3 bietet einen breiteren MCP-Workflow; MailCatcher und Mailpit bieten kein integriertes MCP. Für Mailpit gibt es keine Kompatibilitätsfassade. Die standardmäßig deaktivierte Option `-maildev-rest-compat` stellt die aktuellen
...
Wenn Sie bei der Übersetzung dieses Dokuments helfen möchten:

1. Forken Sie das Repository
2. Erstellen Sie einen Branch für Ihre Übersetzung
3. Übersetzen Sie den Inhalt der [englischen Fassung](../en/Comparison-and-Migration.md)
4. Reichen Sie einen Pull Request ein

Weitere Informationen finden Sie im [Beitragsleitfaden](../../.github/CONTRIBUTING.md).
