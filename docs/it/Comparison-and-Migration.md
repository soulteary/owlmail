...
OwlMail 0.9.0 include interfacce MCP di sola lettura, disattivate per impostazione predefinita, tramite Streamable HTTP e stdio. MailDev 3 offre un flusso MCP più ampio; MailCatcher non include MCP. L'opzione `-maildev-rest-compat`, disattivata per impostazione predefinita,
