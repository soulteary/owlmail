# OwlMail × MailDev × MailCatcher × Mailpit: guida a funzionalità, API e migrazione
...
OwlMail, MailDev, MailCatcher e Mailpit coprono gli stessi flussi di sviluppo fondamentali, ma **non
...
OwlMail 0.10.0 include interfacce MCP di sola lettura, disattivate per impostazione predefinita, tramite Streamable HTTP e stdio. MailDev 3 offre un flusso MCP più ampio; MailCatcher e Mailpit non includono MCP. Per Mailpit non esiste alcuna facade di compatibilità. L'opzione `-maildev-rest-compat`, disattivata per impostazione predefinita,
