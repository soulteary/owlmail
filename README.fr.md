...
| `-mcp-allowed-origins` | `OWLMAIL_MCP_ALLOWED_ORIGINS` | - | Origines de navigateur supplémentaires acceptées sur `/mcp`, en plus de celles d'OwlMail ; `*` désactive la validation d'origine |
